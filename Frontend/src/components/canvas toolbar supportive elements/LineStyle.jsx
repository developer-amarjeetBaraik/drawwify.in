    ...
    return (
        <div>
            <button className={styleFromToolbarCSS.toolbarButton}>
                <span className={style.toolbarLineStyleIcon}>
                <svg className={style.LineStyleIcon} role="img" width="13" height="10" focusable="false" aria-hidden="true" viewBox="0 0 13 10" className=""><rect x="0.5" y="0.5" width="12" height="1.5" fill="white"></rect><rect x="0.5" y="3.5" width="12" height="2" fill="white"></rect><rect x="0.5" y="7" width="12" height="3" fill="white"></rect></svg>
