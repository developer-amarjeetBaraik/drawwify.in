                    ...
                    <div className={style.alignOptionDiv}>
                        ...
                        <div className={`${style.optionSection} ${style.secondSection}`}>
                            <div className={`${style.textAlignOption} `}>
                                <button><svg role="img" width="28" height="28" focusable="false" aria-hidden="true" viewBox="0 0 28 28" className=""><line x1="8.75" y1="9.25" x2="19.25" y2="9.25" stroke-width="1.5" stroke="currentColor" stroke-linecap="round"></line><line x1="8.75" y1="14.25" x2="13.25" y2="14.25" stroke-width="1.5" stroke="currentColor" stroke-linecap="round"></line><line x1="8.75" y1="19.25" x2="16.25" y2="19.25" stroke-width="1.5" stroke="currentColor" stroke-linecap="round"></line></svg></button>

                                <button><svg role="img" width="28" height="28" focusable="false" aria-hidden="true" viewBox="0 0 28 28" className=""><line x1="8.75" y1="9.25" x2="19.25" y2="9.25" stroke-width="1.5" stroke="currentColor" stroke-linecap="round"></line><line x1="11.75" y1="14.25" x2="16.25" y2="14.25" stroke-width="1.5" stroke="currentColor" stroke-linecap="round"></line><line x1="9.75" y1="19.25" x2="18.25" y2="19.25" stroke-width="1.5" stroke="currentColor" stroke-linecap="round"></line></svg></button>

                                <button><svg role="img" width="28" height="28" focusable="false" aria-hidden="true" viewBox="0 0 28 28" className=""><line x1="8.75" y1="9.25" x2="19.25" y2="9.25" stroke-width="1.5" stroke="currentColor" stroke-linecap="round"></line><line x1="14.75" y1="14.25" x2="19.25" y2="14.25" stroke-width="1.5" stroke="currentColor" stroke-linecap="round"></line><line x1="11.75" y1="19.25" x2="19.25" y2="19.25" stroke-width="1.5" stroke="currentColor" stroke-linecap="round"></line></svg></button>
                            </div>
                        </div>
                    </div>
                    : null
