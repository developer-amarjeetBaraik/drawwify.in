    ...
    return (
        <div className={style.sidebarDiv}>
            <span className={style.firstSpan}>
                <button className={style.sidebarButton}>
                    <span className={style.shape}>
                        <svg role="img" width="12" height="12" focusable="false" aria-hidden="true" viewBox="0 0 12 12" class=""><path fill="path" stroke-width="1.5" stroke="currentColor" stroke-linecap="round" d="M6 1V6M6 11V6M6 6H11M6 6H1"></path></svg>
                    </span>
            ...
            <span className={style.secondSpan}>
                ...
                <button className={style.sidebarButton}>
                    <span className={style.shape}>
                        <svg role="img" width="12" height="12" focusable="false" aria-hidden="true" viewBox="0 0 12 12" class=""><path fill-rule="evenodd" clip-rule="evenodd" fill="currentColor" d="M1.5 1.5V10.5H10.5V1.5H1.5ZM1 0C0.447715 0 0 0.447715 0 1V11C0 11.5523 0.447715 12 1 12H11C11.5523 12 12 11.5523 12 11V1C12 0.447715 11.5523 0 11 0H1Z"></path></svg>
                    </span>
                    <span className={style.character}>
                        R
                    </span>
                ...
                <button className={style.sidebarButton}>
                    <span className={style.shape}>
                        <svg role="img" width="12" height="12" focusable="false" aria-hidden="true" viewBox="0 0 12 12" class=""><path fill-rule="evenodd" clip-rule="evenodd" fill="currentColor" d="M1.5 6C1.5 8.48528 3.51472 10.5 6 10.5C8.48528 10.5 10.5 8.48528 10.5 6C10.5 3.51472 8.48528 1.5 6 1.5C3.51472 1.5 1.5 3.51472 1.5 6ZM6 0C2.68629 0 0 2.68629 0 6C0 9.31371 2.68629 12 6 12C9.31371 12 12 9.31371 12 6C12 2.68629 9.31371 0 6 0Z"></path></svg>
                    </span>
                    <span className={style.character}>
                        O
                    </span>
                ...
                <button className={style.sidebarButton}>
                    <span className={style.shape}>
                        <svg role="img" width="9" height="9" focusable="false" aria-hidden="true" viewBox="0 0 9 9" class=""><path fill-rule="evenodd" clip-rule="evenodd" fill="currentColor" d="M1.18499 8.59319C0.8921 8.3003 0.916513 7.80101 1.23952 7.478L7.47801 1.23951C7.80102 0.916502 8.30031 0.892089 8.5932 1.18498C8.8861 1.47787 8.86168 1.97716 8.53867 2.30017L2.30018 8.53866C1.97717 8.86167 1.47789 8.88609 1.18499 8.59319Z"></path></svg>
                    </span>
                    <span className={style.character}>
                        L
                    </span>
