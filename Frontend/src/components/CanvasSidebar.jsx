...
const CanvasSidebar = () => {
    ...
    const { sidebarSelectedBtn, setSidebarSelectedBtn } = useContext(sidebarSelectedBtnContext)

    
    return (
        <div className={`${style.sidebarDiv} ${styleFromWorkSpace.workspaceSupportingElement}`}>
            <span className={style.firstSpan}>
                <button value={'insert'} onClick={()=>setSidebarSelectedBtn('insert')} className={`${style.sidebarButton} ${sidebarSelectedBtn === 'insert'?style.activeBtn:null}`}>
            ...
            <span className={style.secondSpan}>
                <button value={'cursor'} onClick={()=>setSidebarSelectedBtn('cursor')} className={`${style.sidebarButton} ${sidebarSelectedBtn === 'cursor'?style.activeBtn:null}`}>
                    <span className={style.shape}>
                ...
                <button value={'square'} onClick={()=>setSidebarSelectedBtn('square')} className={`${style.sidebarButton} ${sidebarSelectedBtn === 'square'?style.activeBtn:null}`}>
                    <span className={style.shape}>
                ...
                <button value={'circle'} onClick={()=>setSidebarSelectedBtn('circle')} className={`${style.sidebarButton} ${sidebarSelectedBtn === 'circle'?style.activeBtn:null}`}>
                    <span className={style.shape}>
                ...
                <button value={'arrow'} onClick={()=>setSidebarSelectedBtn('arrow')} className={`${style.sidebarButton} ${sidebarSelectedBtn === 'arrow'?style.activeBtn:null}`}>
                    <span className={style.shape}>
                ...
                <button value={'line'} onClick={()=>setSidebarSelectedBtn('line')} className={`${style.sidebarButton} ${sidebarSelectedBtn === 'line'?style.activeBtn:null}`}>
                    <span className={style.shape}>
                ...
                <button value={'drow'} onClick={()=>setSidebarSelectedBtn('drow')} className={`${style.sidebarButton} ${sidebarSelectedBtn === 'drow'?style.activeBtn:null}`}>
                    <span className={style.shape}>
                ...
                <button value={'text'} onClick={()=>setSidebarSelectedBtn('text')} className={`${style.sidebarButton} ${sidebarSelectedBtn === 'text'?style.activeBtn:null}`}>
                    <span className={style.shape}>
