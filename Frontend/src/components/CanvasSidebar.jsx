    ...
    return (
        <div className={`${style.sidebarDiv} ${styleFromWorkSpace.workspaceSupportingElement}`}>
            ...
            <span className={style.secondSpan}>
                ...
                <button value={'drow'} onClick={()=>changeSidebarSelectedBtn('drawBtn')} className={`${style.sidebarButton} ${sidebarSelectedBtn === 'drawBtn' || sidebarSelectedBtn === 'pencilDraw'?style.activeBtn:null}`}>
                    <span className={style.shape}>
                ...
                <button value={'text'} onClick={()=>changeSidebarSelectedBtn('textBtn')} className={`${style.sidebarButton} ${sidebarSelectedBtn === 'textBtn'?style.activeBtn:null}`}>
                    <span className={style.shape}>
